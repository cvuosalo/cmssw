...
const Surface::GlobalPoint & volumeHandle::center() const {
  return center_;
}
...
void volumeHandle::buildPhiZSurf(double startPhi,
						       double deltaPhi,
						       double zhalf,
						       double rCentr) {
...
const Surface & 
volumeHandle::surface(Sides which_side) const {
...
const Surface & 
volumeHandle::surface(int which_side) const {
